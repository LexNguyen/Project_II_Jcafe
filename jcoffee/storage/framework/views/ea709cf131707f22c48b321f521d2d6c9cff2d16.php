...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="<?php echo e(route('showAll')); ?>"><i class='fa fa-link'></i> <span>Quản Lý Sinh Viên</span></a></li>
            <li><a href="<?php echo e(route('class_show_all')); ?>"><i class='fa fa-link'></i> <span>Quản Lý Lớp Học</span></a></li>
            
        </ul><!-- /.sidebar-menu -->
    </section>
    <!-- /.sidebar -->
</aside>
<?php /**PATH C:\xampp\htdocs\project\jcoffee\resources\views/vendor/adminlte/layouts/partials/sidebar.blade.php ENDPATH**/ ?>